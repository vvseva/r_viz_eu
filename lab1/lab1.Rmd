...
Это почти совсем как настоящий датасет из образовательной аналитики. На одном курсе по юриспруденции в Недерландах студентам предложиди воспользоваться мобильным приложением, где они могли отвечать на вопросы про курс и лучше подготовиться к экзамену. Эти данные кластеризовали каким-то гаусовским алгоритмом и отдали вам для визуализации.

1.  **profile --** выделленый кластер, к которому принадлежат студенты
...
7.  **mean_time, min_time, max_time --** среднее, минимальное и максимально время ответа в приложении
